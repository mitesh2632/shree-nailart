<script setup>
import logoDark from "../../assets/img/Shree.jpg";
defineProps({
  brand: {
    type: Object,
    name: String,
    ...
    default: () => [
      {
        ...
        link: "https://www.instagram.com/shree_nail_art_02/",
      },
    ],
  },
  menus: {
    ...
    default: () => [
      {
        ...
        items: [
          {
            name: "Sarthana Jakatnaka, Surat, Gujarat - 395006",
          },
          {
            name: "shreenailart00@gmail.com",
          },
        ],
      },
    ],
